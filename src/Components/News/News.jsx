    ...
    return (
        <div className='Container'>
            <div className='w-2/5  h-full  overflow-y-scroll pl-5'>
                <div className='w-5/6 h-5/6  rounded-lg m-4 bg-red-yellow'>

                    <div className='w-full h-3/5 bg-red-500 rounded-lg relative top-2 flex items-center justify-center'>Image</div>
